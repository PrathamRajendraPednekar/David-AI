...
AssistantVoice = env_vars.get("AssistantVoice", "en-US-JennyNeural")  # Provide a default voice if not set

# Define the path where the speech file will be saved
file_path = r"C:\Users\prath\OneDrive\Desktop\Jarvis\Data\speech.mp3"  
...
async def TextToAudioFile(text):
    try:
        ...
        communicate = edge_tts.Communicate(text, AssistantVoice, pitch='+5Hz', rate='-10%') # to make her speed change of talking
